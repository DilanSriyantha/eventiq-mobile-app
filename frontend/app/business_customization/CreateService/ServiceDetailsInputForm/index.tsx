...
import { ServiceDetailsInputFormProps } from "./types";
...
const ServiceDetailsInputForm = ({ initialData, onInitialize, onSubmit, onDelete }: ServiceDetailsInputFormProps) => {
...
export default memo(ServiceDetailsInputForm);